...
while True:
    ...
    # Draw base line
    cv2.line(frame, (0, 500), (800, 500), (255, 50, 25), 2, cv2.LINE_AA)
    ...
    for index in indices:
       ...
       # Count + if centroid lies on the line
       if (centroid_y == 500) and classes[class_ids[index]] == "tree":
           count += 1
       ...
       cv2.putText(frame, text_count, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 128, 255), 2)
